...
namespace LYSWGuardData
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public static string connectionString = @"Data Source=192.168.3.128;database=akwfy;User Id=root;Password=root;pooling=false;CharSet=utf8;port=3306;Persist Security Info=False";
